...
import com.mmt.travel.app.NFR.Latency.util.ByteBufferUtil;
import com.mmt.travel.app.NFR.Latency.util.VisibleForTesting;
import com.mmt.travel.app.common.util.Charsets;
...
public class VmTraceParser {
    ...
    public static VmTraceHandler traceDataHandler;
    ...
    public long parseHeader(File f) throws IOException {
        long offset = 0;
